...
BOT_NAME = 'itiger_scrapy'

SPIDER_MODULES = ['itiger_scrapy.spiders']
NEWSPIDER_MODULE = 'itiger_scrapy.spiders'
...
DOWNLOADER_MIDDLEWARES = {
   'itiger_scrapy.middlewares.UserAgentMiddleware': 543,
}
ITEM_PIPELINES = {
   'itiger_scrapy.pipelines.ItigerScrapyPipeline': 300,
}
