import redis
BOT_NAME = 'jqka10_scrapy'

SPIDER_MODULES = ['jqka10_scrapy.spiders']
NEWSPIDER_MODULE = 'jqka10_scrapy.spiders'
...
DOWNLOADER_MIDDLEWARES = {
   'jqka10_scrapy.middlewares.UserAgentMiddleware': 543,
}
ITEM_PIPELINES = {
   'jqka10_scrapy.pipelines.Jqka10ScrapyPipeline': 300,
