...
BOT_NAME = 'xueqiu_scrapy'

SPIDER_MODULES = ['xueqiu_scrapy.spiders']
NEWSPIDER_MODULE = 'xueqiu_scrapy.spiders'
...
DOWNLOADER_MIDDLEWARES = {
   'xueqiu_scrapy.middlewares.UserAgentMiddleware': 543,
}
ITEM_PIPELINES = {
   'xueqiu_scrapy.pipelines.XueqiuScrapyPipeline': 300,
}
